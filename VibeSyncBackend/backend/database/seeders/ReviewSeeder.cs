...
public class ReviewSeeder
{
    ...
    public ReviewSeeder(DatabaseContext dbContext)
    {
        _dbContext = dbContext;
    }

    public void SeedInitialReviews()
    {
        ...
        var reviews = new List<Review>()
        {
            new Review
            {
                Text = "O experiență relaxantă la pescuit, recomand!",
                Score = 9,
            ...
            new Review
            {
                Text = "Pescuitul a fost minunat, mi-a plăcut mult!",
                Score = 10,
            ...
            new Review
            {
                Text = "Abia aștept evenimentul, organizatorul este serios și de încredere!",
                Score = 8,
            ...
            new Review
            {
                Text = "Am fost la ediția trecută și a fost o experiență grozavă!",
                Score = 9,
            ...
            new Review
            {
                Text = "Super atmosferă la gaming night, m-am distrat mult!",
                Score = 10,
                UserId = new Guid("10e1fd21-38d9-4c83-a7b2-c370e53b95d6"),
            ...
            new Review
            {
                Text = "Eveniment caritabil deosebit, bine organizat!",
                Score = 9,
                UserId = new Guid("022a8895-fe55-4e13-8bd9-402709435f78"),
            ...
            new Review
            {
                Text = "Am fost la mai multe evenimente ale organizatorului și recomand!",
                Score = 8,
                UserId = new Guid("1e5fe355-5a9f-484f-bff6-f497f5fc0609"),
            ...
            new Review
            {
                Text = "Muzică jazz excelentă și vinuri de calitate!",
                Score = 10,
                UserId = new Guid("ef043f56-86d2-4b68-9e03-996aadf92c76"),
